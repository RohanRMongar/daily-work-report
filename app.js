...
/***** Submit (no-cors) with idempotency *****/
...
function makeSID() {
  // stable unique id for this submission
...
form.addEventListener("submit", async (e) => {
  ...
  data.append("sid", makeSID());     // <— add unique id for backend dedupe
